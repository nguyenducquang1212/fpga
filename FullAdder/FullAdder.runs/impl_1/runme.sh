...
HD_PWD='/home/quangnd12/EmbeddedSystem/fpga/FullAdder/FullAdder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fullAdder2Bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fullAdder2Bit.tcl -notrace
