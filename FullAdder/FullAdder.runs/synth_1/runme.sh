...
HD_PWD='/home/quangnd12/EmbeddedSystem/fpga/FullAdder/FullAdder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fullAdder2Bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fullAdder2Bit.tcl
